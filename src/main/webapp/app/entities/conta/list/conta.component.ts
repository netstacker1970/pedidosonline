...
import { EntityArrayResponseType, ContaService } from '../service/conta.service';
...
export class ContaComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.contas = this.refineData(dataFromBody);
  }

  protected refineData(data: IConta[]): IConta[] {
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.contaService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
