package br.pedidosonline.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.pedidosonline.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.pedidosonline.repository.UserRepository.USERS_BY_EMAIL_CACHE);
