...
import br.pedidosonline.domain.Cliente;
import br.pedidosonline.repository.ClienteRepository;
...
/**
 * REST controller for managing {@link br.pedidosonline.domain.Cliente}.
 */
@RestController
@RequestMapping("/api")
@Transactional
