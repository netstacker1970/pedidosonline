...
class ProdutoResourceIT {
    ...
    private static final LocalDate DEFAULT_PRODUTO = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_PRODUTO = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Produto createEntity(EntityManager em) {
        Produto produto = new Produto().produto(DEFAULT_PRODUTO).image(DEFAULT_IMAGE).imageContentType(DEFAULT_IMAGE_CONTENT_TYPE);
        return produto;
    }
    ...
    public static Produto createUpdatedEntity(EntityManager em) {
        Produto produto = new Produto().produto(UPDATED_PRODUTO).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
        return produto;
    }
    ...
    void createProduto() throws Exception {
        ...
        assertThat(testProduto.getImage()).isEqualTo(DEFAULT_IMAGE);
        assertThat(testProduto.getImageContentType()).isEqualTo(DEFAULT_IMAGE_CONTENT_TYPE);
    }
    ...
    void putExistingProduto() throws Exception {
        ...
        updatedProduto.produto(UPDATED_PRODUTO).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
        ...
        assertThat(testProduto.getImage()).isEqualTo(UPDATED_IMAGE);
        assertThat(testProduto.getImageContentType()).isEqualTo(UPDATED_IMAGE_CONTENT_TYPE);
    }
    ...
    void fullUpdateProdutoWithPatch() throws Exception {
        ...
        partialUpdatedProduto.produto(UPDATED_PRODUTO).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
