...
import br.pedidosonline.repository.CategoriaRepository;
...
class CategoriaResourceIT {
    ...
    public static Categoria createEntity(EntityManager em) {
        Categoria categoria = new Categoria().categoria(DEFAULT_CATEGORIA);
        return categoria;
    }
    ...
    public static Categoria createUpdatedEntity(EntityManager em) {
        Categoria categoria = new Categoria().categoria(UPDATED_CATEGORIA);
        return categoria;
    }
    ...
    void putExistingCategoria() throws Exception {
        ...
        updatedCategoria.categoria(UPDATED_CATEGORIA);
    ...
    void partialUpdateCategoriaWithPatch() throws Exception {
        ...
        partialUpdatedCategoria.categoria(UPDATED_CATEGORIA);
